...
_i1.GetIt init(
  ...
  gh.lazySingleton<_i7.IsBoxEmptyUseCase>(
      () => _i7.IsBoxEmptyUseCase(gh<_i5.CharactersRepository>()));
  gh.lazySingleton<_i8.SaveCharactersUseCase>(
      () => _i8.SaveCharactersUseCase(gh<_i5.CharactersRepository>()));
  gh.factory<_i9.SplashScreenCubit>(() => _i9.SplashScreenCubit(
        gh<_i6.GetCharactersUseCase>(),
        gh<_i8.SaveCharactersUseCase>(),
        gh<_i7.IsBoxEmptyUseCase>(),
      ));
  return getIt;
}
