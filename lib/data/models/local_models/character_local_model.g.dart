...
part of 'character_local_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class CharacterLocalModelAdapter extends TypeAdapter<CharacterLocalModel> {
  @override
  final int typeId = 1;

  @override
  CharacterLocalModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, CharacterLocalModel obj) {
    writer
      ..writeByte(20)
      ..writeByte(0)
      ..write(obj.id)
  ...
  bool operator ==(Object other) =>
      ...
      other is CharacterLocalModelAdapter &&
